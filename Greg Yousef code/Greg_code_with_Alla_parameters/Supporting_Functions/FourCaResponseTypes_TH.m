...
% Default 70;
% Increased to 200 on 05/17/19 by GH
% For the bath applicatons, we don't want the LL classification
LL_Dur = 200; %The duration (sec) of Ca elevation that determines whether the 
%signal is LL or not
...
if CaDur>200 %Lasts > 200 sec
    ...
    RespType='O (Too long)';
elseif max(PeakVal)<0.3 %if the LARGEST peak is too small (<0.4 microM)
