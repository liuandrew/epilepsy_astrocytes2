...
%for Amp = linspace(0.2,0.9,5)
for Amp = [0.2, 0.45, 0.7]
    count_drise = 0;
    ...
    %for d_rise = linspace(1,41,LengthDrise)
    for d_rise = [15, 30, 45]
        ...
        for r_rise = r_rise_Vals; %or use "r_rise_Vals" to go through all possible r_rise values from above
            ...
            %d_decay_values = linspace(15,220,6)
            d_decay_values = [20, 100, 180] 
